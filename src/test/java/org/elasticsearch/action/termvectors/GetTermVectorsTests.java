...
public class GetTermVectorsTests extends AbstractTermVectorsTests {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (ft.storeTermVectors()) {
                ...
                for (int j = 0; j < values.length; j++) {
                    ...
                    PostingsEnum docsAndPositions = iterator.postings(null, null, PostingsEnum.FLAG_ALL);
    ...
    private void compareTermVectors(String fieldName, Fields fields0, Fields fields1) throws IOException {
        ...
        for (int i = 0; i < terms0.size(); i++) {
            ...
            PostingsEnum docsAndPositions0 = iter0.postings(null, null, PostingsEnum.FLAG_ALL);
            PostingsEnum docsAndPositions1 = iter1.postings(null, null, PostingsEnum.FLAG_ALL);
