        ...
        for(int seg=0;seg<numSegs;seg++) {
            if (termsEnums[seg].seekExact(id)) {
                ...
                if (segVersions != null || hasPayloads[seg] == false) {
                    ...
                    PostingsEnum docs = docsEnums[seg] = termsEnums[seg].postings(liveDocs[seg], docsEnums[seg], PostingsEnum.FLAG_NONE);
                ...
                PostingsEnum dpe = posEnums[seg] = termsEnums[seg].postings(liveDocs[seg], posEnums[seg], PostingsEnum.FLAG_PAYLOADS);
